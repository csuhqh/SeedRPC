...
inline void TestMessageSetExtension1::set_test_aliasing(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 test_aliasing_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline void TestMessageSetExtension1::_internal_set_test_aliasing(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  test_aliasing_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline std::string* TestMessageSetExtension1::_internal_mutable_test_aliasing() {
  _has_bits_[0] |= 0x00000001u;
  return test_aliasing_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void TestMessageSetExtension2::set_str(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void RawMessageSet_Item::set_message(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;

...
inline void TestDiffMessage_Item::set_b(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 b_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void TestDiffMessage::set_w(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 w_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());

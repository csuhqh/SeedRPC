#ifndef SRC_NET_RPC_RPC_CHANNEL_H
#define SRC_NET_RPC_RPC_CHANNEL_H
...
#define NEWRPCCONTROLLER(var_name) \
  std::shared_ptr<seedrpc::RpcController> var_name = std::make_shared<seedrpc::RpcController>(); \

#define NEWRPCCHANNEL(addr, var_name) \
  std::shared_ptr<seedrpc::RpcChannel> var_name = std::make_shared<seedrpc::RpcChannel>(seedrpc::RpcChannel::FindAddr(addr)); \

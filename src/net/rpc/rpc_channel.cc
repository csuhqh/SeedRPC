...
void RpcChannel::CallMethod(const google::protobuf::MethodDescriptor* method,
  ...
  std::shared_ptr<seedrpc::TinyPBProtocol> req_protocol = std::make_shared<seedrpc::TinyPBProtocol>();
  ...
  TimerTask::s_ptr timer_event = std::make_shared<TimerTask>(my_controller->GetTimeout(), false, [my_controller, channel]() mutable {
  ...
  m_client->addTimerTask(timer_event);
  ...
  m_client->connect([req_protocol, this]() mutable {
    ...
    getTcpClient()->writeMessage(req_protocol, [req_protocol, this, my_controller](AbstractProtocol::s_ptr) mutable {
      INFOLOG("%s | send rpc request success. call method name[%s], peer addr[%s], local addr[%s]", 
        ...
        std::shared_ptr<seedrpc::TinyPBProtocol> rsp_protocol = std::dynamic_pointer_cast<seedrpc::TinyPBProtocol>(msg);
